...
--- @return string|table|nil if an error occurred or nil if the operation was successful
...
--- @return table|nil from the database or nil if an error occurred
--- @return string|table|nil if an error if an error occurred or nil if the operation was successful
