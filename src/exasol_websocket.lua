...
--- @return string|table|nil <code>nil</code> if the operation was successful, otherwise the error that occured
...
--- @return table|string|nil <code>nil</code> if the operation was successful, otherwise the error that occured
