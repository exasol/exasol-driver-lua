...
-- @return table|nil `nil` if the operation was successful, otherwise the error that occured
...
-- @param attribute_name string the name of the attribute to set, e.g. `"autocommit"`
-- @param attribute_value any the value of the attribute to set, e.g. `false`
-- @return table|nil `nil` if the operation was successful, otherwise the error that occured
...
-- @param ignore_response boolean|nil `false` if we expect a response, else `true`.
--   Default is `false`.
