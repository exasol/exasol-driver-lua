...
function TEST_CONNECTION.test_version()
...
function TEST_CONNECTION.test_connection_fails()
    local real_connection = get_connection_params()
    local tests = {
        {
            props = get_connection_params({host = "wronghost", port = "1234"}),
...
function TEST_CONNECTION.test_connection_succeeds()
