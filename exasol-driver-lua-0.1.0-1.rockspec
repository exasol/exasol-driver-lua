...
build = {
    ...
    modules = {
        ...
        ConnectionProperties = "src/ConnectionProperties.lua",
        Connection = "src/Connection.lua",
        constants = "src/constants.lua",
        CursorData = "src/CursorData.lua",
        Cursor = "src/Cursor.lua",
        Environment = "src/Environment.lua",
        ExasolWebsocket = "src/ExasolWebsocket.lua",
        luws = "src/luws.lua",
        util = "src/util.lua",
        WebsocketDatahandler = "src/WebsocketDatahandler.lua",
