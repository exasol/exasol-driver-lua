...
describe("ExasolWebsocket", function()
    ...
    it("returns error without details when login command fails", function()
    ...
    it("returns error with nil details when login command fails", function()
    ...
    it("returns error with details when login command fails", function()
