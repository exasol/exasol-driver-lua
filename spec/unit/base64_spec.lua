...
describe("base64", function()
    ...
    describe("works with original test suite from https://github.com/iskolbin/lbase64/blob/master/test.lua", function()
        ...
        test('Man is distinguished, not only by his reason, but by this singular passion from other animals, which '
             ...
             'TWFuIGlzIGRpc3Rpbmd1aXNoZWQsIG5vdCBvbmx5IGJ5IGhpcyByZWFzb'
                     .. '24sIGJ1dCBieSB0aGlzIHNpbmd1bGFyIHBhc3Npb24gZnJvbSBvdGhlciBhbmltYWxzLCB3aGljaCBpcyBhIGx1c3Qgb2'
                     .. 'YgdGhlIG1pbmQsIHRoY'
                     .. 'XQgYnkgYSBwZXJzZXZlcmFuY2Ugb2YgZGVsaWdodCBpbiB0aGUgY29udGludWVkIGFuZCBpbmRlZmF0aWdhYmxlIGdlbm'
                     .. 'VyYXRpb24gb2Yga25vd'
        ...
        test('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et '
             ...
             'TG9yZW0gaXBzdW0gZG9sb3Igc2l0IGFtZXQsIGNvbnNlY3RldHVyIGFkaXBpc2NpbmcgZWxpdCwgc2VkIGRvIGVp'
                     .. 'dXNtb2QgdGVtcG9yIGluY2lkaWR1bnQgdXQgbGFib3JlIGV0IGRvbG9yZSBtYWduYSBhbGlxdWEuIFV0IGVuaW0gYWQgb'
                     .. 'WluaW0gdmVuaWFtLCBxdWlzIG5vc3RydWQgZXhlcmNpdGF0aW9uIHVsbGFtY28gbGFib3JpcyBuaXNpIHV0IGFsaXF1aX'
                     .. 'AgZXggZWEgY29tbW9kbyBjb25zZXF1YXQuIER1aXMgYXV0ZSBpcnVyZSBkb2xvciBpbiByZXByZWhlbmRlcml0IGluIHZ'
                     .. 'vbHVwdGF0ZSB2ZWxpdCBlc3NlIGNpbGx1bSBkb2xvcmUgZXUgZnVnaWF0IG51bGxhIHBhcmlhdHVyLiBFeGNlcHRldXIg'
                     .. 'c2ludCBvY2NhZWNhdCBjdXBpZGF0YXQgbm9uIHByb2lkZW50LCBzdW50IGluIGN1bHBhIHF1aSBvZmZpY2lhIGRlc2Vyd'
        ...
        test('\137\080\078\071\013\010\026\010\000\000\000\013\073\072\068\082\000\000\000\032\000\000\000\032'
                     .. '\001\003\000\000\000\073\180\232\183\000\000\000\006\080\076\084\069\255\255\255\000'
                     .. '\000\000\085\194\211\126\000\000\000\018\073\068\065\084\008\215\099\248\015\004\196'
                     .. '\016\084\006\196\218\011\000\237\189\063\193\243\000\141\059\000\000\000\000\073\069'
                     .. '\078\068\174\066\096\130',
             'iVBORw0KGgoAAAANSUhEUgAAACAAAAAgAQMAAABJtOi3AAAABlBMVEX///8AAABVwtN+'
        ...
        it("ignores whitespace in base64 encoded text", function()
            assert(base64.decode(
                    'wйqеvнQсуkкiеDнRгhш9щCзwх0ъфYыnвQаsпNрGоFллIдNжGэOё0яLчPQsCDQttC40Lsg0LHRiyDRhtC'
                            .. '40YLRgNGD0YE/INсCмUи0тLьAбsюIЙКNЕG\n\n\n\n\r\rE0LDQu9GM0YjQuNCy0YvQuSDRjdC60LfQtdC80'
                            .. 'L/Qu9GP0YAhwrs=')
