...
luacheck "$src_module_path" --max-line-length 140 --codes --exclude-files src/luws.lua

# (W111) setting non-standard global variable TEST
# (W112) mutating non-standard global variable TEST
# (W212) unused argument self
luacheck "$test_module_path" --max-line-length 140 --codes --ignore 111 --ignore 112 --ignore 212
