...
`exasol-driver-lua` follows the API of [LuaSQL](https://github.com/lunarmodules/luasql/), so the [LuaSQL manual](https://keplerproject.github.io/luasql/manual.html) is a good starting point.
